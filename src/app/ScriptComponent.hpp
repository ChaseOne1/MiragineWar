...
#define GET_ID(ent) (ent.raw_get<entt::entity>("id"))
    ...
    static void RegisterComponent()
    {
        ...
        auto type = app::ScriptManager::GetLuaState()
                        .new_usertype<T>(refl.name().data() + std::string("Comp"));
...
#define REGISTER_TO_ENV(T) \
    static void RegisterToEnv() { app::detail::RegisterComponent<T>(); }
