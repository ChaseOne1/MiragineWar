...
1. 克隆本仓库
```shell
mkdir MiragineWar && cd MiragineWar
git clone --recursive --depth 1 https://github.com/ChaseOne1/MiragineWar.git
```
2. 使用CMake编译
```shell
...
```
2. 启动客户端，打开`MiragineWar-Game/MiragineWar.exe`，能够看到游戏窗口：
